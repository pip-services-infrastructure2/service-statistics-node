...
var plugin = require('service-statistics-node').StatisticsSenecaPlugin;
...
or by using [StatisticsSenecaClient](https://github.com/pip-services-infrastructure2/client-statistics-node/NodeClientApiV1.md/#client_seneca)